# ============================================================
# IOZ (iShares ASX 200 ETF) - Moving Average Crossover Backtest
...
axes[1].plot(df.index, df["price"], label="IOZ price", color="grey", linewidth=1)
